...
import GameOfStones.Results.GameResult;
...
public class ScoreboardSceneController {
    ...
    private void initialize(){
        ...
        List<GameResult> gameResultsList = new CreateScoreFile().getGameScoreList();
    ...
    public void buttonPressed(ActionEvent actionEvent) throws IOException {
        ...
        if (button.getId().equals("mainMenuButton")) {
    ...
    private List<GameResult> getTop5(List<GameResult> gameResultsList){
        ...
        log.info("Showing top 5 results!");
